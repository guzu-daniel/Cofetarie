...
<meta charset="utf-8" />
        ...
        <title>Adaugare Prajitura</title>
...
<section>
 ...
 <br><br><br><br><br>
<h1>Adaugare Prajitura</h1>
<form:form action="${pageContext.request.contextPath}/prajitura/add-save.htm" method="post" commandName="prajituraForm">
