...
<!-- Navigation-->
 ...
 <br><br><br><br><br>
<h1>Editare Prajitura</h1>
<h2><c:out value="${model.mesaj}"/></h2>
<form:form action="${pageContext.request.contextPath}/prajitura/save.htm" method="post" commandName="prajituraForm">
